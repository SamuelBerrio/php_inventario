...
if ($total >= 1 && $pagina <= $Npaginas) {
    ...
    // Recorrer los datos obtenidos y construir las filas de la tabla con la información de cada usuario.
...
// Imprimir la tabla generada con los datos de los usuarios.
echo $tabla;
